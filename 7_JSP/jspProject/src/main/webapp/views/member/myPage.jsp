...
<body>
    ...
    <div class="outer">
        ...
        <form action="<%=contextPath %>/update.me" method="post" id="update-form">
            ...
            <div align="center">
                <button type="submit" class="btn btn-sm btn-secondary" data-bs-target="#update-member">
                정보 변경
                </button>
                ...
                <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#delete-member-modal">
                회원탈퇴
                </button>
            </div>
        </form>
